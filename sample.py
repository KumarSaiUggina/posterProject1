...
# MongoDB connection
client = MongoClient("mongodb+srv://kattamanchimaheshreddy1414:SSMB29@cluster0.xexe6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
db = client['competition_db2']
